...
public class ConstantMessage {
    public static final String MESSAGE_OK = "Successfully processed.";
    public static final String MESSAGE_SYSTEM_ERROR = "An error has occurred on the server. Please contact your administrator.";

    public static final String ID_ERR00001 = "ERR00001";
    public static final String ID_ERR00002 = "ERR00002";
    ...
    public static final String ID_BKE00035 = "BKE00035";
